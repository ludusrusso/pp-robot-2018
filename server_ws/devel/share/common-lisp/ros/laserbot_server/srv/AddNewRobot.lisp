...
(cl:in-package laserbot_server-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <AddNewRobot-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddNewRobot-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laserbot_server-srv:<AddNewRobot-request> is deprecated: use laserbot_server-srv:AddNewRobot-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddNewRobot-request>)))
  ...
  "laserbot_server/AddNewRobotRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddNewRobot-request)))
  "Returns string type for a service object of type 'AddNewRobot-request"
  "laserbot_server/AddNewRobotRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <AddNewRobot-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddNewRobot-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laserbot_server-srv:<AddNewRobot-response> is deprecated: use laserbot_server-srv:AddNewRobot-response instead.")))

(cl:ensure-generic-function 'ID-val :lambda-list '(m))
(cl:defmethod ID-val ((m <AddNewRobot-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laserbot_server-srv:ID-val is deprecated.  Use laserbot_server-srv:ID instead.")
  (ID m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddNewRobot-response>)))
  ...
  "laserbot_server/AddNewRobotResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddNewRobot-response)))
  "Returns string type for a service object of type 'AddNewRobot-response"
  "laserbot_server/AddNewRobotResponse")
