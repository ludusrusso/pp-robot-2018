...
/* This function is invoked every UPDATE_AREA ms.
  ...
  function updateGameArea() {
    ...
    var left  = myGameArea.keys && ( myGameArea.keys[37] || myGameArea.keys[65]) || joystick.left();
    var up    = myGameArea.keys && ( myGameArea.keys[38] || myGameArea.keys[87]) || joystick.up();
    var right = myGameArea.keys && ( myGameArea.keys[39] || myGameArea.keys[68]) || joystick.right();
    var down  = myGameArea.keys && ( myGameArea.keys[40] || myGameArea.keys[83]) || joystick.down();
    var shoot = myGameArea.keys && ( myGameArea.keys[13] || myGameArea.keys[32] );


    /* Joystick debug message*/
