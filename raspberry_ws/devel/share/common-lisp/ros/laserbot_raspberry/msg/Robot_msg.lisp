...
(cl:in-package laserbot_raspberry-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Robot_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Robot_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laserbot_raspberry-msg:<Robot_msg> is deprecated: use laserbot_raspberry-msg:Robot_msg instead.")))

(cl:ensure-generic-function 'linear_x-val :lambda-list '(m))
(cl:defmethod linear_x-val ((m <Robot_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laserbot_raspberry-msg:linear_x-val is deprecated.  Use laserbot_raspberry-msg:linear_x instead.")
  (linear_x m))

(cl:ensure-generic-function 'angular_z-val :lambda-list '(m))
(cl:defmethod angular_z-val ((m <Robot_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laserbot_raspberry-msg:angular_z-val is deprecated.  Use laserbot_raspberry-msg:angular_z instead.")
  (angular_z m))

(cl:ensure-generic-function 'shoot-val :lambda-list '(m))
(cl:defmethod shoot-val ((m <Robot_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laserbot_raspberry-msg:shoot-val is deprecated.  Use laserbot_raspberry-msg:shoot instead.")
  (shoot m))
