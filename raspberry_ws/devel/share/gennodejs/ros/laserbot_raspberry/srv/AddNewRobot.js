...
// (in-package laserbot_raspberry.srv)
...
class AddNewRobotRequest {
  ...
  static datatype() {
    ...
    return 'laserbot_raspberry/AddNewRobotRequest';
  }
...
class AddNewRobotResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'laserbot_raspberry/AddNewRobotResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'laserbot_raspberry/AddNewRobot'; }
};
